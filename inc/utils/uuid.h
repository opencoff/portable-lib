 ...
 *
 * utils/uuid.h - Generic, v4/v5 Random UUIDs
 *
...
#ifndef ___UTILS_UUID_H__b1X8cs6fV5k9lYUw___
#define ___UTILS_UUID_H__b1X8cs6fV5k9lYUw___ 1
 ...
 */
extern int uuid_generate(uint8_t *buf, size_t bsiz);
 ...
 */
extern int uuid_fromstring(uint8_t *buf, size_t bsiz, const char *str);
 ...
 */
extern int uuid_tostring(char *str, size_t bsiz, const uint8_t *buf);

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif /* ! ___UTILS_UUID_H__b1X8cs6fV5k9lYUw___ */
